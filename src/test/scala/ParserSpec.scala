...
class ParserSpec extends FlatSpec with Matchers {
  ...
  it should "return proper AST" in {
  ...
  it should "return proper binary operation" in {
  ...
  it should "return proper expression" in {
  ...
  it should "implemented syntax sugar for fun def" in {
  ...
  it should "return proper TopDeclaration" in {
  ...
  "parseProgram" should "return proper parsed program ast" in {
